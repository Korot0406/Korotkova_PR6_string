...
// Задание 1. Вводится строка произвольного текста. Вывести на экран все символы, не являющиеся буквами и цифрами. Если таких символов нет, вывести -1.
void problem1(){}

// Задание 2. Вводится строка произвольного текста. Заменить все цифры на соответствующие им символы *. Вывести преобразованную таким образом строку.
void problem2(){
